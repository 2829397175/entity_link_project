    ...
    for batch in tqdm(dataloader):
        ...
        for predict_score, world, label in zip(predict_scores, worlds, labels):
            ...
            if accumulate_score:
                ...
                ids = 0
                while len(predict_title_dict.keys()) < 64:#top_k[-1]:
            ...
            candidates.append([{"label_title":label_title, 'title': title,"qid": dataset.get_qid_from_title(title)} for title in predict_title])
    print(score_metrics)
